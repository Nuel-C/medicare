                                ...
                                <div className='container' style={{marginTop:'5%'}} key={dat._id}>
                                    ...
                                    <table className='container'>
                                        <tbody>
                                            ...
                                            <tr>
                                                <th style={{width:'20%', borderBottom:'1px solid black'}}>Ward</th>
                                                <td style={{width:'80%', textAlign:'left', paddingLeft:'2%'}}>{dat.ward}</td>
                                            </tr>
                                            <tr>
                                                <th style={{width:'20%', borderBottom:'1px solid black'}}>L.G.A</th>
                                                <td style={{width:'80%', textAlign:'left', paddingLeft:'2%'}}>{dat.lga}</td>
                                            </tr>
                                            <tr>
                                                <th style={{width:'20%', borderBottom:'1px solid black'}}>State</th>
                                                <td style={{width:'80%', textAlign:'left', paddingLeft:'2%'}}>{dat.state}</td>
                                            </tr>
                                            <tr>
